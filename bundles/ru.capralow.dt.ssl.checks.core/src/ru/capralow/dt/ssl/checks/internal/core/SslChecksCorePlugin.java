 ...
 */
package ru.capralow.dt.ssl.checks.internal.core;
...
public class SslChecksCorePlugin
    extends Plugin
{
    public static final String ID = "ru.capralow.dt.ssl.checks"; //$NON-NLS-1$

    private static SslChecksCorePlugin instance;
    ...
    public static SslChecksCorePlugin getInstance()
    {
        return instance;
    }
