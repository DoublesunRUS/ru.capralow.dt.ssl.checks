...
public class ObjectFormModuleNotConnectedTests
{
    ...
    {
        testingWorkspace.setUpProject("v3_1_1", ObjectFormModuleNotConnectedTests.class); //$NON-NLS-1$
    }

    @Test
    public void testExecuteCommandAtServerNoExcessiveMethod() throws Exception
    {
        TestingWorkspaceUtils.checkNoIssue("v3_1_1", "src/Documents/НеПодключен/Forms/ФормаДокумента/Module.bsl", //$NON-NLS-1$//$NON-NLS-2$
