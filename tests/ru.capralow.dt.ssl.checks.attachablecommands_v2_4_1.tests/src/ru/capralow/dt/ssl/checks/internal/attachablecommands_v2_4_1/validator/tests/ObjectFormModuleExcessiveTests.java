...
public class ObjectFormModuleExcessiveTests
{
    ...
    {
        testingWorkspace.setUpProject("v2_4_1", ObjectFormModuleExcessiveTests.class); //$NON-NLS-1$
    }
    ...
    public void testExecuteCommandAtServerExcessiveMethod() throws Exception
    {
        TestingWorkspaceUtils.checkIssue("v2_4_1", //$NON-NLS-1$
            ...
            ObjectFormModule.ERROR_METHOD_EXECUTE_COMMAND_AT_SERVER_EXCESSIVE_METHOD, Severity.WARNING, 39);
    }
    ...
    public void testExecuteCommandExcessiveMethod() throws Exception
    {
        TestingWorkspaceUtils.checkIssue("v2_4_1", //$NON-NLS-1$
            "src/Documents/НенужныеПроцедурыИВызовы/Forms/ФормаДокумента/Module.bsl", //$NON-NLS-1$
            ObjectFormModule.ERROR_METHOD_EXECUTE_COMMAND_EXCESSIVE_METHOD, Severity.WARNING, 31);
    }
    ...
    public void testOnCreateAtServerExcessiveCall() throws Exception
    {
        TestingWorkspaceUtils.checkIssue("v2_4_1", //$NON-NLS-1$
            "src/Documents/НенужныеПроцедурыИВызовы/Forms/ФормаДокумента/Module.bsl", //$NON-NLS-1$
            ObjectFormModule.ERROR_METHOD_ON_CREATE_AT_SERVER_EXCESSIVE_CALL, Severity.WARNING, 5);
    }
    ...
    public void testOnOpenExcessiveCall() throws Exception
    {
        TestingWorkspaceUtils.checkIssue("v2_4_1", //$NON-NLS-1$
            "src/Documents/НенужныеПроцедурыИВызовы/Forms/ФормаДокумента/Module.bsl", //$NON-NLS-1$
            ObjectFormModule.ERROR_METHOD_ON_OPEN_EXCESSIVE_CALL, Severity.WARNING, 23);
    }
    ...
    public void testOnReadAtServerExcessiveCall() throws Exception
    {
        TestingWorkspaceUtils.checkIssue("v2_4_1", //$NON-NLS-1$
            "src/Documents/НенужныеПроцедурыИВызовы/Forms/ФормаДокумента/Module.bsl", //$NON-NLS-1$
            ObjectFormModule.ERROR_METHOD_ON_READ_AT_SERVER_EXCESSIVE_CALL, Severity.WARNING, 14);
    }
    ...
    public void testRereadCommandsExcessiveMethod() throws Exception
    {
        TestingWorkspaceUtils.checkIssue("v2_4_1", //$NON-NLS-1$
            "src/Documents/НенужныеПроцедурыИВызовы/Forms/ФормаДокумента/Module.bsl", //$NON-NLS-1$
            ObjectFormModule.ERROR_METHOD_REREAD_COMMANDS_EXCESSIVE_METHOD, Severity.WARNING, 47);
    }
