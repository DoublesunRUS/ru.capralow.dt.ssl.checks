 ...
 */
package ru.capralow.dt.ssl.checks.internal.attachablecommands_v3_1_1.validator;
    ...
    extends NLS
{
    private static final String BUNDLE_NAME =
        "ru.capralow.dt.ssl.checks.internal.attachablecommands_v3_1_1.validator.messages"; //$NON-NLS-1$
    ...
    public static String Error_ObjectFormModule_MethodExecuteCommandAtServerMissingExport;
