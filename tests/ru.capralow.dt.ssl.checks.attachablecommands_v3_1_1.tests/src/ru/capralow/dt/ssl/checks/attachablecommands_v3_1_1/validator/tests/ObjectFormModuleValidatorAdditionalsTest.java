...
public class ObjectFormModuleValidatorAdditionalsTest
{
    ...
    {
        testingWorkspace.setUpProject("v3_1_1", ObjectFormModuleValidatorAdditionalsTest.class); //$NON-NLS-1$
    }
    ...
    {
        TestingWorkspaceUtils.checkNoIssue("v3_1_1", "src/Documents/ВнешниеБезВызовов/Forms/ФормаДокумента/Module.bsl", //$NON-NLS-1$//$NON-NLS-2$
            ObjectFormModuleValidator.ERROR_METHOD_EXECUTE_COMMAND_AT_SERVER_NOT_EXISTS);
    }
    ...
    {
        TestingWorkspaceUtils.checkIssue("v3_1_1", "src/Documents/ВнешниеБезВызовов/Forms/ФормаДокумента/Module.bsl", //$NON-NLS-1$//$NON-NLS-2$
    ...
    {
        TestingWorkspaceUtils.checkNoIssue("v3_1_1", "src/Documents/ВнешниеБезПроцедур/Forms/ФормаДокумента/Module.bsl", //$NON-NLS-1$//$NON-NLS-2$
            ObjectFormModuleValidator.ERROR_METHOD_EXECUTE_COMMAND_AT_SERVER_MISSING_CALL);
    }
    ...
    {
        TestingWorkspaceUtils.checkIssue("v3_1_1", "src/Documents/ВнешниеБезПроцедур/Forms/ФормаДокумента/Module.bsl", //$NON-NLS-1$//$NON-NLS-2$
    ...
    {
        TestingWorkspaceUtils.checkNoIssue("v3_1_1", //$NON-NLS-1$
            "src/Documents/ВнешниеВсёНастроено_2_4_1/Forms/ФормаДокумента/Module.bsl", //$NON-NLS-1$
            ObjectFormModuleValidator.ERROR_METHOD_EXECUTE_COMMAND_AT_SERVER_NOT_EXISTS);
    }
