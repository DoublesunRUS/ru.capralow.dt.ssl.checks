...
Процедура ПриОпределенииОбъектовСКомандамиЗаполнения(Объекты) Экспорт
	...
	Объекты.Добавить(Метаданные.Документы.ЗаполнениеВсёНастроено_2_4_1);
	Объекты.Добавить(Метаданные.Документы.ЗаполнениеВсёНастроено);
	ЗаполнениеОбъектовВложенныйМодуль1.ОпределитьОбъектыСКомандамиЗаполнения(Объекты);
