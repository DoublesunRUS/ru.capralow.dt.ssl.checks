...
public class ObjectFormModulePrintsTests
{
    ...
    {
        testingWorkspace.setUpProject("v2_4_1", ObjectFormModulePrintsTests.class); //$NON-NLS-1$
    }

    @Test
    public void testAllExecuteCommandAtServerExists() throws Exception
    {
        TestingWorkspaceUtils.checkNoIssue("v2_4_1", "src/Documents/ПечатьВсёНастроено/Forms/ФормаДокумента/Module.bsl", //$NON-NLS-1$//$NON-NLS-2$
    ...
    {
        TestingWorkspaceUtils.checkNoIssue("v2_4_1", "src/Documents/ПечатьБезВызовов/Forms/ФормаДокумента/Module.bsl", //$NON-NLS-1$//$NON-NLS-2$
            ObjectFormModule.ERROR_METHOD_EXECUTE_COMMAND_AT_SERVER_NOT_EXISTS);
    }
    ...
    {
        TestingWorkspaceUtils.checkIssue("v2_4_1", "src/Documents/ПечатьБезВызовов/Forms/ФормаДокумента/Module.bsl", //$NON-NLS-1$//$NON-NLS-2$
    ...
    {
        TestingWorkspaceUtils.checkNoIssue("v2_4_1", "src/Documents/ПечатьБезПроцедур/Forms/ФормаДокумента/Module.bsl", //$NON-NLS-1$//$NON-NLS-2$
            ObjectFormModule.ERROR_METHOD_EXECUTE_COMMAND_AT_SERVER_MISSING_CALL);
    }
    ...
    {
        TestingWorkspaceUtils.checkIssue("v2_4_1", "src/Documents/ПечатьБезПроцедур/Forms/ФормаДокумента/Module.bsl", //$NON-NLS-1$//$NON-NLS-2$
