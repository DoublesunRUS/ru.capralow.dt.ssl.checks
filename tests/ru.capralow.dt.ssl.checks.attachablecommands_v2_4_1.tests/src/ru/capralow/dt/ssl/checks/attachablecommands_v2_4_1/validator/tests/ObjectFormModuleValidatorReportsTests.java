...
public class ObjectFormModuleValidatorReportsTests
{
    ...
    {
        testingWorkspace.setUpProject("v2_4_1", ObjectFormModuleValidatorReportsTests.class); //$NON-NLS-1$
    }

    @Test
    public void testAllExecuteCommandAtServerExists() throws Exception
    {
        TestingWorkspaceUtils.checkNoIssue("v2_4_1", "src/Documents/ОтчетыВсёНастроено/Forms/ФормаДокумента/Module.bsl", //$NON-NLS-1$//$NON-NLS-2$
    ...
    {
        TestingWorkspaceUtils.checkNoIssue("v2_4_1", "src/Documents/ОтчетыБезВызовов/Forms/ФормаДокумента/Module.bsl", //$NON-NLS-1$//$NON-NLS-2$
            ObjectFormModuleValidator.ERROR_METHOD_EXECUTE_COMMAND_AT_SERVER_NOT_EXISTS);
    }
    ...
    {
        TestingWorkspaceUtils.checkIssue("v2_4_1", "src/Documents/ОтчетыБезВызовов/Forms/ФормаДокумента/Module.bsl", //$NON-NLS-1$//$NON-NLS-2$
    ...
    {
        TestingWorkspaceUtils.checkIssue("v2_4_1", "src/Documents/ОтчетыБезПроцедур/Forms/ФормаДокумента/Module.bsl", //$NON-NLS-1$//$NON-NLS-2$
